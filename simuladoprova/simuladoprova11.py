...
print(f'Seu salario base é de R$ {salario}')
print(f'O percentual do aumento é de {percentual}')
print(f'O valor do aumento é de: R$ {aumento}')
print(f'O seu salario final é de {salarioPos}')